...
const en: Dict = {
  ...
  siteName: "Site name",
  siteNamePlaceholder: "Use server site name",
  show: "Show",
  hide: "Hide",
  solid: "Solid",
  frosted: "Frosted",
  ...
  logoUrl: "Logo URL or local path",
  removeLogo: "Remove",
  cropLogo: "Crop logo",
  apply: "Apply",
  cancel: "Cancel",
  ...
  backgroundVideoUrl: "Video URL or local path",
...
const zhCN: Dict = {
  ...
  overviewInfo: "总览信息",
  siteName: "站点名称",
  siteNamePlaceholder: "默认使用后端站点名称",
  show: "显示",
  hide: "隐藏",
  solid: "实心",
  frosted: "磨砂",
